 ...
 * the app in this browser and never again — tracked in localStorage rather
  ...
  return (
    ...
    >
      <div className="animate-in flex w-full max-w-md flex-col items-center text-center">
        ...
        >
          Every required passage with a click-to-gloss vocabulary, highlighting and notes as you
          read, spaced-repetition review, and an AP-style quiz and scansion lab — all built around
