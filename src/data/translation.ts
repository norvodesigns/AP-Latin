...
praetendi taedas aut haec in foedera veni.`,
    ...
    segments: [
      ...
      {
        id: 's11', latin: 'neque ego hanc … fugam',
        literal: 'nor (did) I (hope to conceal) this flight',
        requirement: 'hanc agreeing with fugam across the intervening words.',
        pitfalls: ['Failing to connect hanc with fugam — they are separated by four words.'],
        tags: ['adjective-agreement', 'hyperbaton'],
      },
      {
        id: 's12', latin: 'abscondere furto speravi',
        literal: 'did I hope to hide by stealth',
        requirement: 'Perfect speravi with complementary infinitive; furto ablative of means.',
        pitfalls: ['Present "I hope".', 'Reading furto as dative.'],
        tags: ['perfect-tense', 'complementary-infinitive', 'ablative-means'],
      },
      {
        id: 's13', latin: '(ne finge)',
        literal: '(do not imagine it)',
        requirement: 'Negative command with ne + present imperative (poetic for noli fingere).',
        pitfalls: ['Rendering as a statement.', 'Missing the prohibition entirely.'],
        tags: ['negative-command', 'imperative'],
      },
      {
